...
Given a collection of posterior predictive quantile results $q_1, \ldots, q_n$, what can we do?

**Main point** if our forecast is calibrated then $q_i \sim \mathcal{U}[0, 1]$.
