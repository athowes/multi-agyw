...
* Estimate proportions indexed by
  * District $i = 1, \ldots, n$
    * 13 AGYW Global Fund priority countries (but fitting individually): Botswana, Cameroon, Kenya, Lesotho, Malawi, Mozambique, Namibia, South Africa, Swaziland, Tanzania, Uganda, Zambia and Zimbabwe
  * Survey $t = 1, \ldots, T$
    * The available DHSs
...
```{r echo=FALSE}
knitr::include_graphics("../../archive/check_sexpaid-survey-question/20210720-120340-77026581/sexpaid-survey-question.pdf")
```
