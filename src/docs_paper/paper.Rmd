...
Using our estimates, we calculated the HIV prevalence, people living with HIV (PLHIV), HIV incidence, and number of new HIV infections in each risk, age, and district strata by disaggregating estimates from the Naomi model [@eaton2021naomi].
...
<!-- \midrule -->
<!-- None & Not sexually active & 0 (Excludes incidence from non-sexual transmission, e.g. unsafe injection, which is negligible in these populations.) \\ -->
<!-- Low & One cohabiting sexual partner & 1 (Baseline group.) \\ -->
<!-- High & Non-regular sexual partner(s) & 1.72 (Based upon analyses of risk factors for incident HIV infection from studies in sub-Saharan Africa by \citet{slaymaker2020croi} and \citet{jia2022risk}.) \\ -->
<!-- Very high & Female sex workers & { -->
<!-- \begin{tabularx}{\cellwidth}{ll} -->
<!-- \hline -->
<!-- District-level HIV incidence & Risk ratio \Top{}\\ -->
<!-- $>$3.0\% & 3 \\ -->
<!-- 1.0-3.0\% & 6 \\ -->
<!-- 0.3-1.0\% & 9 \\ -->
<!-- 0.1-0.3\% & 13 \\ -->
...
<!-- \bottomrule -->
<!-- \end{tabularx} -->
<!-- \caption{HIV risk groups and risk ratios giving the ratio of probabilities of being sexually infected with HIV in the next year relative to the baseline group. Risk ratios for the highest risk group vary based upon general population HIV incidence and are based upon a UNAIDS analysis led by Keith Sabin.} -->
...
We disaggregated HIV incidence by risk group linearly using the HIV infection risk ratios given in Table.
...
```{r echo=FALSE, fig.cap="Surveys used in our analysis by year, survey type, sample size, and whether the survey included a transactional sex question."}
...
We included `r total_surveys` surveys in our analysis (Figure, Table), with a total sample size of `r agyw_surveyd` women aged 15-29 years (`r agyw_surveyed_age$Y015_019` aged 15-19 years, `r agyw_surveyed_age$Y020_024` aged 20-24 years, and `r agyw_surveyed_age$Y025_029` aged 25-29 years).
Of these, `r length(giftsvar_surveys)` surveys included a specific transactional sex question, with corresponding sample size `r agyw_surveyed_giftsvar` (`r agyw_surveyed_giftsvar_age$Y015_019` aged 15-19 years, `r agyw_surveyed_giftsvar_age$Y020_024` aged 20-24 years, and `r agyw_surveyed_giftsvar_age$Y025_029` aged 25-29 years).
...
Model performance according to the CPO criteria is provided in the appendix (Figures, Tables) for all considered models.
...
```{r echo=FALSE, fig.cap="Percentage of new infections reached across all 13 countries, taking a variety of risk stratification approaches, against the percentage of at risk population reached."}
