...
knitr::include_graphics("depends/available-surveys.jpeg")
```
...
Model performance according to the CPO criteria is provided in Appendix A.1.2.4 for all considered models.
...
knitr::include_graphics("depends/3p1-continental-map.jpeg")
```
...
knitr::include_graphics("depends/3p1-within-between-country-variation.jpeg")
```
...
knitr::include_graphics("depends/infections-reached.jpeg")
```
...
However, we did not include these factors in view of measurement difficulties, consistency across contexts, and the operational benefits of describing risk parsimoniously.
...
In adjusting our estimates of transactional sex to match national FSW estimates, we inherent their limitations. 
