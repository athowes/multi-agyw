...
Very high & Transactional sex & $<$0.1\% & 25.0 \\
 & & 0.1-0.3\% & 13.0 \\
 & & 0.3-1.0\% & 9.0 \\
 & & 1.0-3.0\% & 6.0 \\
 & & $>$3.0\% & 3.0 \\
\bottomrule
\end{tabularx}
\caption{HIV risk groups and assumed HIV incidence rate ratio for each risk group relative to AGYW with one cohabiting sexual partner. Among FSW, the incidence rate ratio depended on the level of HIV incidence among the general population. The incidence rate ratio for women with non-regular or multiple sexual partner(s) was derived from analysis of ALPHA network data. The transactional sex risk group is adjusted during analysis to correspond to female sex worker, and incidence rate ratios among FSW were dervied based on patterns of relative HIV prevalence among FSW compared to general population prevalence. }
...
abstract: |
  ...
  **Results:**
  ...
  Female sex workers were `r inf_fsw$prop_population_cumulative`\% of the population but `r inf_fsw$prop_infections_averted_cumulative`\% of all expected new infections.
...
Third, we provide estimates in all district-years, including those not directly sampled by surveys, allowing estimates to be consistently fed into further analysis and planning pipelines.
...
These reporting biases will also have distorted of our estimates of infection risk ratios and prevalence ratios, likely over-attributing risk to higher risk groups.
