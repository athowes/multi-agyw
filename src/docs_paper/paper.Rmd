...
<!-- As both community-level epidemic indicators and individual-level behaviours determine risk of acquiring HIV, it is important to consider both of these factors in tandem to enable more efficient prioritisation of prevention services. -->
...
Four prioritisation strata (Table) were defined based on: (1) subnational annual incidence (<0.3\%, 0.3-1.0\%, 1.0-3.0\% and >3.0\%), and (2) self-reported high-risk behaviour or recent STI infection.
...
\bottomrule
\end{tabularx}
\caption{HIV risk groups and assumed HIV incidence rate ratios giving the ratio of probabilities of being sexually infected with HIV in the next year relative to the baseline group.}
...
Exact survey questions varied slightly between surveys (Appendix B).
...
Some surveys included a specific question asking if the respondent had received money or gifts for sex in the past twelve months; in these surveys, 2.64\% of women reported transactional sex.
...
Because of this incomparably across surveys, we did not include surveys without a specific transactional sex question when estimating the proportion of the population who were FSW or engaged in transactional sex.
We focused on estimating the proportion of women who reported transactional sex at a district level, and subsequently adjsuted these proportions to align to national estimates for the number of female sex workers.
...
As surveys were only available in the years 2013-2018, we assumed the proportion in the very high risk group among those in at least the high risk group was constant over time.
...
Technical details of the model are in Appendix A.
...
We disaggregated HIV incidence by risk group using the HIV infection risk ratios given in Table \ref{tab:risk-groups}.
...
For the non-regular partner(s) risk group, the risk ratio was based on analyses of risk factors for incident HIV infection from studies in sub-Saharan Africa by @slaymaker2020croi and supported by the review of @jia2022risk.
Risk ratios for the highest risk group vary based upon general population HIV incidence and are based on a UNAIDS analysis led by Keith Sabin.
...
To do so, we ordered the strata by descending incidence before cumulatively summing the expected incidence and population.
...
abstract: |
  ...
  **Results:**
  ...
  Among women aged 20-29, cohabiting (`r dividing_border_above_sexcohab$median`\%) was more common in eastern Africa than non-regular partner(s) (`r dividing_border_above_sexnonreg$median`\%), while in southern countries non-regular partner(s) (`r dividing_border_below_sexnonreg$median`\%) were more common than cohabiting (`r dividing_border_below_sexcohab$median`\%).
