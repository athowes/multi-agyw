...
# orderly::orderly_develop_start("tgo_survey_behav_men")
# setwd("src/tgo_survey_behav_men")

#' ISO3 country code
iso3 <- "TGO"

areas <- read_sf("depends/tgo_areas.geojson") %>% st_make_valid()
...
write_csv(survey_indicators, "tgo_survey_indicators_sexbehav.csv", na = "")
...
write_csv(hiv_indicators, "tgo_hiv_indicators_sexbehav.csv", na = "")
