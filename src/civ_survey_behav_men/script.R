...
# orderly::orderly_develop_start("civ_survey_behav_men")
# setwd("src/civ_survey_behav_men")

#' ISO3 country code
iso3 <- "CIV"

areas <- read_sf("depends/civ_areas.geojson") %>% st_make_valid()
...
#' PHIA data
phia_survey_meta <- read_csv("depends/civ2017phia_survey_meta.csv")
phia_survey_regions <- read_csv("depends/civ2017phia_survey_regions.csv")
phia_survey_clusters <- read_csv("depends/civ2017phia_survey_clusters.csv")
phia_survey_individuals <- read_csv("depends/civ2017phia_survey_individuals.csv")
phia_survey_biomarker <- read_csv("depends/civ2017phia_survey_biomarker.csv")
phia_survey_sexbehav <- read_csv("depends/civ2017phia_survey_sexbehav.csv")
...
write_csv(survey_indicators, "civ_survey_indicators_sexbehav.csv", na = "")
...
write_csv(hiv_indicators, "civ_hiv_indicators_sexbehav.csv", na = "")
