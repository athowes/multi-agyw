...
# orderly::orderly_develop_start("lbr_survey_behav_men")
# setwd("src/lbr_survey_behav_men")

#' ISO3 country code
iso3 <- "LBR"

areas <- read_sf("depends/lbr_areas.geojson") %>% st_make_valid()
...
write_csv(survey_indicators, "lbr_survey_indicators_sexbehav.csv", na = "")
...
write_csv(hiv_indicators, "lbr_hiv_indicators_sexbehav.csv", na = "")
