...
# orderly::orderly_develop_start("gha_survey_behav_men")
# setwd("src/gha_survey_behav_men")

#' ISO3 country code
iso3 <- "GHA"

areas <- read_sf("depends/gha_areas.geojson") %>% st_make_valid()
...
write_csv(survey_indicators, "gha_survey_indicators_sexbehav.csv", na = "")
...
write_csv(hiv_indicators, "gha_hiv_indicators_sexbehav.csv", na = "")
