# orderly::orderly_develop_start("civ_survey_phia")
# setwd("src/civ_survey_phia/")
...
survey_region_areas %>% filter(is.na(survey_region_id))

#' Check any survey regions with no areas
survey_region_areas %>% filter(is.na(area_id))
...
survey_clusters <- survey_clusters %>%
  left_join(
    rename(survey_region_areas, geometry_area = geometry),
