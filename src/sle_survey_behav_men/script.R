...
# orderly::orderly_develop_start("sle_survey_behav_men")
# setwd("src/sle_survey_behav_men")

#' ISO3 country code
iso3 <- "SLE"

areas <- read_sf("depends/sle_areas.geojson") %>% st_make_valid()
...
write_csv(survey_indicators, "sle_survey_indicators_sexbehav.csv", na = "")
...
write_csv(hiv_indicators, "sle_hiv_indicators_sexbehav.csv", na = "")
