...
# orderly::orderly_develop_start("ago_survey_behav_men")
# setwd("src/ago_survey_behav_men")

#' ISO3 country code
iso3 <- "AGO"

areas <- read_sf("depends/ago_areas.geojson") %>% st_make_valid()
...
write_csv(survey_indicators, "ago_survey_indicators_sexbehav.csv", na = "")
...
write_csv(hiv_indicators, "ago_hiv_indicators_sexbehav.csv", na = "")
