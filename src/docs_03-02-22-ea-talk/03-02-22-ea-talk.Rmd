...
```{r echo=FALSE}
knitr::include_graphics("depends/model-direct-benefits-h.pdf")
```
...
```{r echo=FALSE}
knitr::include_graphics("geometry-graph-zwe.pdf")
```
...
```{r echo=FALSE}
knitr::include_graphics("depends/infections-averted-country.pdf")
```
