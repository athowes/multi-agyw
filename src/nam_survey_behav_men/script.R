...
# orderly::orderly_develop_start("nam_survey_behav_men")
# setwd("src/nam_survey_behav_men")
...
#' PHIA data
phia_survey_meta <- read_csv("depends/nam2017phia_survey_meta.csv")
phia_survey_regions <- read_csv("depends/nam2017phia_survey_regions.csv")
phia_survey_clusters <- read_csv("depends/nam2017phia_survey_clusters.csv")
phia_survey_individuals <- read_csv("depends/nam2017phia_survey_individuals.csv")
phia_survey_biomarker <- read_csv("depends/nam2017phia_survey_biomarker.csv")
phia_survey_sexbehav <- read_csv("depends/nam2017phia_survey_sexbehav.csv")
...
write_csv(survey_indicators, "nam_survey_indicators_sexbehav.csv", na = "")
...
write_csv(hiv_indicators, "nam_hiv_indicators_sexbehav.csv", na = "")
