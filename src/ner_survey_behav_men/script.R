...
# orderly::orderly_develop_start("ner_survey_behav_men")
# setwd("src/ner_survey_behav_men")

#' ISO3 country code
iso3 <- "NER"

areas <- read_sf("depends/ner_areas.geojson") %>% st_make_valid()
...
write_csv(survey_indicators, "ner_survey_indicators_sexbehav.csv", na = "")
...
write_csv(hiv_indicators, "ner_hiv_indicators_sexbehav.csv", na = "")
