...
# orderly::orderly_develop_start("ken_survey_behav_men")
# setwd("src/ken_survey_behav_men")
...
survey_region_areas <- filter(survey_region_areas, !is.na(survey_id)) #' This is coming up just in KEN
...
write_csv(hiv_indicators, "ken_hiv_indicators_sexbehav.csv", na = "")
