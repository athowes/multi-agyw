...
data.frame(
  ...
  ggplot(aes(x = price, y = effectiveness, label = name)) +
    geom_text() +
    labs(x = "Price", y = "Effectiveness", title = "Not all interventions can, or should, be provided to everyone", caption = "Possible interventions for reducing HIV incidence in AGYW. Positions on plot depend\n on setting, and is subject to uncertainty, so should not be interpreted too precisely.") +
